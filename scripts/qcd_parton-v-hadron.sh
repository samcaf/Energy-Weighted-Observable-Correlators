...
for Rjet in 1000.0 1.0;
  for rsub in 0.0 0.1;
    ...
    ./write_tools/write_ewocs -n 10000 -l parton -p qcd -j $alg_prefix'akt' -s $alg_prefix'ca' -R $Rjet -r $rsub --pt_min 50 --pt_max 3000;
    ./write_tools/write_ewocs -n 10000 -l hadron -p qcd -j $alg_prefix'akt' -s $alg_prefix'ca' -R $Rjet -r $rsub --pt_min 50 --pt_max 3000;
  end;
end;
end
